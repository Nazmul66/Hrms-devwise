  ...
  const data = [
    {
      ...
      details: 'HRMS software is highly scalable, which means it can grow with your business. You can add new features and functionalities as your business grows and your needs change. You can also add new users to the system as your business expands.',
      imgSre: '/featureHome.png',
      img: "/Home/image_01.png",
      alt: 'feature home'
    },
    {
      title: 'Scalability',
      subTitle: 'Scalability and Flexibility',
      details: 'TechForing HRMS is designed to scale and adapt to the evolving needs of growing organizations. You can easily add new employees, departments, or locations without system constraints, ensuring the agility and responsiveness of the HRMS to your changing requirements.',
      imgSre: '/featureHome2.png',
      img: "/Home/image_02.png",
      alt: 'feature home'
    },
    {
      title: 'Cost Savings',
      subTitle: 'Cost Savings',
      details: 'Implementing TechForing HRMS solutions can lead to significant cost savings for clients. Achieve cost effectiveness by streamlining HR processes, eliminating manual paperwork, reducing errors, and optimizing resource allocation; so that you can allocate the HR budget more effectively.',
      imgSre: '/featureHome3.png',
      img: "/Home/image_03.png",
      alt: 'feature home'
    },
    {
      ...
      imgSre: '/featureHome4.png',
      img: "/Home/image_04.png",
      alt: 'feature home'
    }
  ]
    ...
    <>
      <div className='mt-24 lg:block hidden'>
        <div className="custom-container">
          <h1 className={h.title}>Why should you prefer <span>Techfroing HRMS</span> Over Others?</h1>
      ...
      <div className='lg:hidden block px-4 py-10'>
        <h2 className='roboto text-[#333] font-bold text-[18px] leading-[22px] text-center'>Why should you prefer <span className='text-green'>Techfroing HRMS</span> Over Others?</h2>
