...
const Account_tab = [
  {
    img: "/Home/Accounts_icons/Budget.png",
    img2: "/Home/Accounts_icons/Budget_white.png",
    content: "Budget",
    match: "Budget"
  },
  {
    img: "/Home/Accounts_icons/cart.png",
    img2: "/Home/Accounts_icons/cart_white.png",
    content: "Sales",
    match: "Sales"
  },
  {
    img: "/Home/Accounts_icons/cash_money.png",
    img2: "/Home/Accounts_icons/cash_money_white.png",
    content: "Cash Flow",
    match: "Cash"
  },
  {
    img: "/Home/Accounts_icons/expense.png",
    img2: "/Home/Accounts_icons/expense_white.png",
    content: "Expense",
    match: "Expense"
  },
  {
    img: "/Home/Accounts_icons/payroll.png",
    img2: "/Home/Accounts_icons/payroll_white.png",
    content: "Payroll",
    match: "Payroll"
  },
  {
    img: "/Home/Accounts_icons/Asset.png",
    img2: "/Home/Accounts_icons/Asset_white.png",
    content: "Asset",
    match: "Asset"
  },
  {
    img: "/Home/Accounts_icons/Tax.png",
    img2: "/Home/Accounts_icons/Tax_white.png",
    content: "Tax",
    match: "Tax"
  },
  {
    img: "/Home/Accounts_icons/Report.png",
    img2: "/Home/Accounts_icons/Report_white.png",
    content: "Report",
    match: "Report"
  },
]
    ...
    <>
      <div className='mt-32 lg:block hidden'>
        <div className='main_container'>
          <h1 className="roboto text-[36px] leading-[48px] font-bold text_gradient_finance text-center">Comprehensive HRMS Solution for All HRMS Operations</h1>
          ...
          <div className='mt-32 mb-24 flex justify-between items-center gap-16'>
            ...
            <div className='w-[40%] translate-x-[-10px]'>
              <div className="relative">
                <img src="/Home/Accounts_icons/account_images.png" alt="" />

                <img src="/Home/Accounts_icons/anim_01.png" alt="" className="accounting_anim_01 shadow-iconShadow" />
                <img src="/Home/Accounts_icons/anim_02.png" alt="" className="accounting_anim_02 shadow-iconShadow" />
                <img src="/Home/Accounts_icons/anim_03.png" alt="" className="accounting_anim_03 shadow-iconShadow" />
                <img src="/Home/Accounts_icons/anim_04.png" alt="" className="accounting_anim_04 shadow-iconShadow" />
                <img src="/Home/Accounts_icons/anim_05.png" alt="" className="accounting_anim_05 shadow-iconShadow" />
              </div>
            </div>
          </div>
        </div>
...
const account_tab_contents = [
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Budget_creation.png",
        icon_content: "Budget creation"
      },
      {
        icon: "/Home/Accounts_icons/Budget_Management.png",
        icon_content: "Budget Management"
      },
      {
        icon: "/Home/Accounts_icons/Budget_Tracking.png",
        icon_content: "Budget Tracking"
      },
      {
        icon: "/Home/Accounts_icons/Budget_history.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Sales_Processes.png",
        icon_content: "Streamline Sales Processes"
      },
      {
        icon: "/Home/Accounts_icons/Customer_Engagement.png",
        icon_content: "Enhance Customer Engagement"
      },
      {
        icon: "/Home/Accounts_icons/Flow_Management.png",
        icon_content: "Improve Cash Flow Management"
      },
      {
        icon: "/Home/Accounts_icons/Actionable_Insights.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Expense_Overview.png",
        icon_content: "Expense Overview"
      },
      {
        icon: "/Home/Accounts_icons/Vendor_Management.png",
        icon_content: "Vendor Management"
      },
      {
        icon: "/Home/Accounts_icons/Project_Expense.png",
        icon_content: "Project Expense Monitoring"
      },
      {
        icon: "/Home/Accounts_icons/Personal_Expense.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Employee_Salary.png",
        icon_content: "Employee Salary Management"
      },
      {
        icon: "/Home/Accounts_icons/Commission_Request.png",
        icon_content: "Commission Request Tracking"
      },
      {
        icon: "/Home/Accounts_icons/Payslip_Generation.png",
        icon_content: "Payslip Generation & Overview"
      },
      {
        icon: "/Home/Accounts_icons/Commission_Slip.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Comprehensive_Overview.png",
        icon_content: "Comprehensive Overview"
      },
      {
        icon: "/Home/Accounts_icons/Real_time_Monitoring.png",
        icon_content: "Real-time Monitoring"
      },
      {
        icon: "/Home/Accounts_icons/Financial_Analysis.png",
        icon_content: "Financial Analysis"
      },
      {
        icon: "/Home/Accounts_icons/Forecasting.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Track_Assets.png",
        icon_content: "Track Assets"
      },
      {
        icon: "/Home/Accounts_icons/Asset_Analysis.png",
        icon_content: "Categorized Asset Analysis"
      },
      {
        icon: "/Home/Accounts_icons/New_Asset.png",
        icon_content: "Add New Asset"
      },
      {
        icon: "/Home/Accounts_icons/Asset_List.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Tax_Returns.png",
        icon_content: "Tax Returns and Payments"
      },
      {
        icon: "/Home/Accounts_icons/Rate_Management.png",
        icon_content: "Tax Rate Management"
      },
      {
        icon: "/Home/Accounts_icons/Rate_Overview.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/Accounts_icons/Balance_Sheet.png",
        icon_content: "Detailed Balance Sheet"
      },
      {
        icon: "/Home/Accounts_icons/law.png",
        icon_content: "Balance management"
      },
      {
        icon: "/Home/Accounts_icons/Expense_Report.png",
        icon_content: "Detailed Expense Report"
      },
      {
        icon: "/Home/Accounts_icons/Report_Distribution.png",
