...
const Auto_carousel = () => {
    // icons changes
     const icons = ["/personal/person_tic.png", "/personal/cash.png", "/personal/doc.png", "/personal/kpi.png", "/personal/message.png", "/personal/operator.png", "/personal/user_secure.png", "/personal/cycle.png"];
                 ...
                 <div className="w-[50%] flex justify-center">
                   <div className='relative w-[250px] h-[250px] bg-[#FBFBFB] rounded-full'>
                      ...
                      <div className='slide_image'>
                          <img src="/personal/person_tic.png" alt="" className='image_slide_show' />
                      </div>
                   </div>
                 </div>
              </div>
                 ...
                 <div className='w-[45%]'>
                    <div className='relative w-[220px] h-[220px] bg-[#FBFBFB] rounded-full ml-[-75px]'>
                        ...
                        <div className='slider_image_containers'>
                            <img src="/personal/person_tic.png" alt="" className='image_slider translate-x-6' />
                        </div>
                    </div>
                 </div>
                 <div className='w-[55%]'>
