   ...
   return (
      <section className="px-4 banner_bg lg:pt-0 pt-10" >
         <div className="main_container flex lg:flex-row flex-col justify-between items-center">
            <div className="lg:w-[50%] w-full">
               <div className="lg:block flex items-center lg:mb-0 mb-5">
                  ...
                  <div className="lg:w-full w-[50%]">
                     <img src="/personal/personal_banner.png" alt="" className="lg:hidden block scale-[1.2]" />
                  </div>
               </div>

               <ul>
                  <li className="flex items-center mb-3">
                     <img src="/personal/icons/tic.png" className="inline w-[18px] lg:w-[23px]" alt="" />
            ...
            <div className="lg:w-[50%] w-full">
               <img src="/personal/personal_banner.png" alt="" className="lg:block hidden" />
            </div>
         </div>
      </section>
   );
