...
const Recruitment_tab = [
  {
    ...
    img2: "/Recruitment/icons/document_white.png",
    content: "Dynamic Job Board",
    match: "job_board"
  },
  {
    img: "/Recruitment/icons/report.png",
    img2: "/Recruitment/icons/report_white.png",
    content: "Hiring Process",
    match: "hiring"
  },
  {
    img: "/Recruitment/icons/user.png",
    img2: "/Recruitment/icons/user_white.png",
    content: "Applicant Management",
    match: "applicant"
  },
  {
    img: "/Recruitment/icons/person_tic.png",
    img2: "/Recruitment/icons/person_tic_white.png",
    content: "Talent Sorting",
    match: "talent"
  },
  {
    img: "/Recruitment/icons/support.png",
    img2: "/Recruitment/icons/support_white.png",
    ...
    <>
      <div className='mt-32 lg:block hidden'>
        <div className='main_container'>
          <h1 className="roboto text-[36px] leading-[48px] font-bold text_gradient_recruitment text-center">AI Recruitment Tool: Discover the Future of Hiring</h1>
          ...
          <div className='mt-32 flex flex-row-reverse justify-between items-center gap-16'>
            ...
            <div className='w-[40%]'>
              <div className="relative">
                <img src="/Home/Recruitment_icons/recruitment_images.png" alt="" />

                <img src="/Home/Recruitment_icons/anim_01.png" alt="" className="recruitment_anim_01 shadow-iconShadow" />
                <img src="/Home/Recruitment_icons/anim_02.png" alt="" className="recruitment_anim_02 shadow-iconShadow" />
                <img src="/Home/Recruitment_icons/anim_03.png" alt="" className="recruitment_anim_03 shadow-iconShadow" />
                <img src="/Home/Recruitment_icons/anim_04.png" alt="" className="recruitment_anim_04 shadow-iconShadow" />
                <img src="/Home/Recruitment_icons/anim_05.png" alt="" className="recruitment_anim_05 shadow-iconShadow" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='lg:hidden block py-10 mx-4 overflow-x-hidden'>
        <h1 className="roboto text-[22px] leading-[32px] font-bold text_gradient_recruitment text-center mb-6">AI Recruitment Tool: Discover the Future of Hiring</h1>
...
const recruitment_tab_contents = [
  {
    ...
    link: "/recruitment#path_1",
    list: [
      {
        icon: "/Home/Recruitment_icons/applicant_tracking.png",
        icon_content: "Applicant Tracking"
      },
      {
        icon: "/Home/Recruitment_icons/file_setting.png",
        icon_content: "Simplified Job Management"
      },
      {
        icon: "/Home/Recruitment_icons/user_send.png",
        icon_content: "Seamless Application Process"
      },
      {
        icon: "/Home/Recruitment_icons/job_listing.png",
  ...
  },
  {
    ...
    link: "/recruitment#path_2",
    list: [
      {
        icon: "/Home/Recruitment_icons/employee_group.png",
        icon_content: "Centralized Candidate Database"
      },
      {
        icon: "/Home/Recruitment_icons/user_setting.png",
        icon_content: "Candidate Management"
      },
      {
        icon: "/Home/Recruitment_icons/tele-communication.png",
        icon_content: "Streamlined Communication"
      },
      {
        icon: "/Home/Recruitment_icons/doc_search.png",
  ...
  },
  {
    ...
    link: "/recruitment#path_3",
    list: [
      {
        icon: "/Home/Recruitment_icons/Applicant_Storage.png",
        icon_content: "Centralized Applicant Storage"
      },
      {
        icon: "/Home/Recruitment_icons/carbon_block-storage.png",
        icon_content: "Centralized Applicant Storage"
      },
      {
        icon: "/Home/Recruitment_icons/Streamlined_Evaluation.png",
        icon_content: "Streamlined Evaluation Process"
      },
      {
        icon: "/Home/Recruitment_icons/Data_Security.png",
  ...
  },
  {
    ...
    link: "/recruitment#path_4",
    list: [
      {
        icon: "/Home/Recruitment_icons/Question_Set.png",
        icon_content: "Predefined Question Set"
      },
      {
        icon: "/Home/Recruitment_icons/Talent_Identification.png",
        icon_content: "Efficient Talent Identification"
      },
      {
        icon: "/Home/Recruitment_icons/Improved_Efficiency.png",
        icon_content: "Improved Efficiency"
      },
      {
        icon: "/Home/Recruitment_icons/Candidate_Selection.png",
  ...
  {
    match: "Support",
    headTitle: "Unlock Data Insights with Our HRMS Reporting Suite",
    para: "Centralize all your company’s reports in one module, including performance, attendance, leave, invoices, pay slips, commissions, and expenses. Make data-driven decisions and drive organizational success with our robust reporting capabilities.",
    link: "/recruitment#path_5",
    list: [
      {
        icon: "/Home/Recruitment_icons/Support_Team.png",
        icon_content: "Access to Professional Support Team"
      },
      {
        icon: "/Home/Recruitment_icons/Timely_Assistance.png",
        icon_content: "Timely Assistance"
      },
      {
        icon: "/Home/Recruitment_icons/Expert_Guidance.png",
        icon_content: "Expert Guidance"
      },
      {
        icon: "/Home/Recruitment_icons/Personalized_Advice.png",
