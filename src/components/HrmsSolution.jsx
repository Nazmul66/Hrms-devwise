    ...
    <>
      <div className='mt-32 lg:block hidden'>
        <div className='main_container'>
          <h1 className="roboto text-[36px] leading-[48px] font-bold text_gradient text-center">Comprehensive HRMS Solution for All HRMS Operations</h1>
          ...
          <div className='mt-32 flex justify-between items-center gap-16'>
            ...
            <div className='w-[40%]'>
              <div className="relative">
                <img src="/Home/HRMS_icons/hrms_images.png" alt="" />

                <img src="/Home/HRMS_icons/anim_01.png" alt="" className="hrms_anim_01 shadow-iconShadow" />
                <img src="/Home/HRMS_icons/anim_02.png" alt="" className="hrms_anim_02 shadow-iconShadow" />
                <img src="/Home/HRMS_icons/anim_03.png" alt="" className="hrms_anim_03 shadow-iconShadow" />
                <img src="/Home/HRMS_icons/anim_04.png" alt="" className="hrms_anim_04 shadow-iconShadow" />
                <img src="/Home/HRMS_icons/anim_05.png" alt="" className="hrms_anim_05 shadow-iconShadow" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div className='lg:hidden block py-10 mx-4 overflow-x-hidden'>
        <h1 className="roboto text-[22px] leading-[32px] font-bold text_gradient text-center mb-6">Comprehensive HRMS Solution for All HRMS Operations</h1>
...
const hrms_tab_contents = [
  {
    ...
    para: "Our HRMS software simplifies employee management with a comprehensive module that centralizes employee records, department management, training tracking, evaluation processes, and resignation handling. With user-friendly interfaces and powerful features, streamline employee management throughout the entire employee lifecycle.",
    link: "/hrms/employee_Management/#management",
    list: [
      {
        icon: "/Home/HRMS_icons/employee_record.png",
        icon_content: "Employee Records"
      },
      {
        icon: "/Home/HRMS_icons/department.png",
        icon_content: "Department Management"
      },
      {
        icon: "/Home/HRMS_icons/training.png",
        icon_content: "Training Tracking"
      },
      {
        icon: "/Home/HRMS_icons/resignation.png",
  ...
  },
  {
    ...
    list: [
      ...
      {
        icon: "/Home/HRMS_icons/user_email.png",
        icon_content: "Leave Request Handling"
      },
      {
        icon: "/Home/HRMS_icons/user_send.png",
        icon_content: "Smooth Onboarding Process"
      },
      {
        icon: "/Home/HRMS_icons/clock.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/HRMS_icons/performance_tracking.png",
        icon_content: "Performance Tracking"
      },
      {
        icon: "/Home/HRMS_icons/kpi_score.png",
        icon_content: "KPI Scores and Bonuses"
      },
      {
        icon: "/Home/HRMS_icons/transparent_component.png",
        icon_content: "Transparent Promotions"
      },
      {
        icon: "/Home/HRMS_icons/face_recognition.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/HRMS_icons/msg.png",
        icon_content: "Communication Hub"
      },
      {
        icon: "/Home/HRMS_icons/env.png",
        icon_content: "Event Management"
      },
      {
        icon: "/Home/HRMS_icons/doc_err.png",
        icon_content: "Termination Process"
      },
      {
        icon: "/Home/HRMS_icons/speaker.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/HRMS_icons/performance_evaluation.png",
        icon_content: "Performance Evaluation"
      },
      {
        icon: "/Home/HRMS_icons/hand_cash.png",
        icon_content: "Expense Analysis"
      },
      {
        icon: "/Home/HRMS_icons/leave_management.png",
        icon_content: "Leave Management"
      },
      {
        icon: "/Home/HRMS_icons/analysis.png",
  ...
  },
  {
    ...
    list: [
      {
        icon: "/Home/HRMS_icons/employee_document.png",
        icon_content: "Employee Document Repository"
      },
      {
        icon: "/Home/HRMS_icons/money_bag.png",
        icon_content: "Expense Management"
      },
      {
        icon: "/Home/HRMS_icons/spreadsheet.png",
        icon_content: "Streamlined Salary Sheets"
      },
      {
        icon: "/Home/HRMS_icons/box_percentage.png",
  ...
  },
  {
    ...
    link: "/hrms/fund/#management",
    list: [
      {
        icon: "/Home/HRMS_icons/fund_calculator.png",
        icon_content: "Simplified Fund Calculations"
      },
      {
        icon: "/Home/HRMS_icons/fund_management.png",
        icon_content: "Employee Regulatory Fund Management"
      },
      {
        icon: "/Home/HRMS_icons/kpi_control.png",
        icon_content: "Transparency and Control"
      },
      {
        icon: "/Home/HRMS_icons/fund_tracking.png",
