...
const Button = ({ style, text, link, className }) => {
  return (
    <a className={`${s.primaryBtn} ${className}`} href={link} target="_blank" rel="noreferrer">
  ...
  return (
    <>
      <div className="mt-24 lg:block hidden" style={{
          backgroundImage: `url(/dataSecurityBG.png)`,
        ...
        <div className="custom-container flex items-center h-[464px] px-16 rounded-lg" >
          <div className='flex flex-col items-center gap-2 w-4/12'>
            ...
            <p className='text-[28px] text-primary font-medium'>Techforing Workwise</p>
          </div>
      ...
      <div className='data_security lg:hidden block'>
        ...
        <p className='roboto text-[14px] font-medium text-center text-green'>Techforing Workwise</p>

        <div className='mt-8'>
          <ul>
            <li className='mb-4'>
              <div className='flex items-center'>
                <img src="/Home/tic.png" alt="" />
