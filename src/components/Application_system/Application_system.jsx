    ...
    return (
     <>
                ...
                <div className='flex lg:flex-row flex-col items-center justify-between gap-8 relative'>
                    ...
                    <div className='lg:w-[50%] w-full'>
                        <div className='w-[450px] h-[400px] flex justify-center items-center relative z-20'>
                          <div className='relative z-10 w-[50px] h-[60px]'>
                             <img src="/Recruitment/user.png" alt="" className='main_user' />
                             <img src="/Recruitment/user.png" alt="" className='img_class_01' />
                             <img src="/Recruitment/user.png" alt="" className='img_class_02' />
                             <img src="/Recruitment/user.png" alt="" className='img_class_03' />
                             <img src="/Recruitment/user.png" alt="" className='img_class_04' />
                             <img src="/Recruitment/user.png" alt="" className='img_class_05' />
                             <img src="/Recruitment/user.png" alt="" className='img_class_06' />
                          </div>

                            <img src="/Recruitment/frame_without_user.png" alt="" className='f_without_user'/>
                            <img src="/Recruitment/cv_frame.png" alt="" className='f_user_01'/>
                            <img src="/Recruitment/cv_frame.png" alt="" className='f_user_02'/>
                        </div>
                    </div>
                    ...
                    <div className="lg:w-[50%] w-full">
                        <div className="application_system activeApplication">
                            <img src="/Recruitment/icons/circle.png" alt="" className='application_img' />
                        ...
                        <div className="application_system">
                            <img src="/Recruitment/icons/doc_err.png" alt="" className='application_img' />
                            <div className='application_main_div'>
                                <div className='application_contents'>
                                <span className='line_shape_area'></span>
                        ...
                        <div className="application_system">
                            <img src="/Recruitment/icons/filter.png" alt="" className='application_img' />
                            <div className='application_main_div'>
                                <div className='application_contents'>
                                <span className='line_shape_area'></span>
        ...
        <div className='lg:hidden block px-4 py-16'>
            ...
            <div className="mb-10">
                <img src="/Recruitment/icons/circle.png" alt="" className='w-[75px] h-[75px] mx-auto mb-5' />
                <div className='relative z-[2]'>
                    <div className='p-5 rounded-md bg-light-white2 shadow-shadow6x'>
                       <span className='absolute top-[20px] left-[20px] w-full h-full bg-light-white z-[-1] rounded-md'></span>
                       <h3 className='roboto font-medium text-[16px] leading-[48px] text_gradient_recruitment'>Statistical Display</h3>
            ...
            <div className="mb-10">
                <img src="/Recruitment/icons/doc_err.png" alt="" className='w-[75px] h-[75px] mx-auto mb-5 ' />
                <div className='relative z-[2]'>
                    <div className='p-5 rounded-md bg-light-white2 shadow-shadow6x'>
                       <span className='absolute top-[20px] left-[20px] w-full h-full bg-light-white z-[-1] rounded-md'></span>
                       <h3 className='roboto font-medium text-[16px] leading-[48px] text_gradient_recruitment'>Candidate Details</h3>
            ...
            <div className="mb-10">
                <img src="/Recruitment/icons/filter.png" alt="" className='w-[75px] h-[75px] mx-auto mb-5' />
                <div className='relative z-[2]'>
                    <div className='p-5 rounded-md bg-light-white2 shadow-shadow6x'>
                       <span className='absolute top-[20px] left-[20px] w-full h-full bg-light-white z-[-1] rounded-md'></span>
                       <h3 className='roboto font-medium text-[16px] leading-[48px] text_gradient_recruitment'>Statistical Display</h3>
