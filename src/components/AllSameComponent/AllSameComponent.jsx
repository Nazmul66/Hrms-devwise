...
import img1 from "@/HRMS/icons/paper.png";
import img2 from "@/HRMS/icons/document.png";
import img3 from "@/HRMS/icons/all_people.png";
import img4 from "@/HRMS/icons/desktop.png";
import img5 from "@/HRMS/icons/list.png";
import manualImage from "@/HRMS/HRMS_Employee_management.png";
import business_team from "@/HRMS/business_team_1.png";
import footer_end_img from "@/HRMS/footer_end_1.png";
import ScreenShot01 from "@/HRMS/screenshot_1.png";
...
import img_png from '@/HRMS/p1.png';
import blob from '@/HRMS/combine_image/blob.png';
import person from '@/HRMS/combine_image/person.png';
import main_frame from '@/HRMS/combine_image/main-frame.png';
import Frame_1 from '@/HRMS/combine_image/Frame-1.png';
import Frame_2 from '@/HRMS/combine_image/Frame-2.png';
import { useEffect, useState } from 'react';
import emp_management from "@/HRMS/icons/employee_management.png";
import attend_management from "@/HRMS/icons/attendance_management.png";
import perform_management from "@/HRMS/icons/performance_management.png";
import fund_management from "@/HRMS/icons/funds.png";
import report_management from "@/HRMS/icons/report_management.png";
import notice_management from "@/HRMS/icons/noticeboard_management.png";
import document_management from "@/HRMS/icons/document_management.png";
import HRMS_Banner_section from '../HRMS_Banner_section/HRMS_Banner_section';
import person_2 from "@/HRMS/person-2.png";
import business_person_banner from '@/HRMS/business_person_banner.png';
import coin from "@/HRMS/coin.png";
                ...
                <div className="main_container flex justify-between items-center">
                    <div className="w-[50%] ml-auto lg:pl-[50px] pl-0">
                        ...
                        <div className="lg:mt-10 mt-5 text-left">
                            <a href="" className="action_btn lg:px-7 px-[14px] lg:py-[10px] py-2">Explore More</a>
                        </div>
                    </div>
                </div>
                ...
                <div className='max-w-[1040px] mx-auto flex justify-between items-center'>
                    <div className="w-[50%]">
                        ...
                        <div className="lg:mt-10 mt-2 text-left">
                            <a href="" className="lg:text-[16px] text-[8.8px] bg-green text-[#FFF] rounded-md font-bold lg:px-7 px-3 lg:py-[10px] py-[6px]">Get A Demo</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='next_level px-4 relative lg:py-0 py-5'>
                ...
                <div className='main_container flex justify-between items-center'>
                    <div className="w-[50%]">
                        ...
                        <div className="lg:mt-10 mt-2 text-left">
                            <a href="" className="lg:text-[16px] text-[8.8px] bg-green text-[#FFF] rounded-md font-bold lg:px-7 px-3 lg:py-[10px] py-[6px]">Start Today</a>
                        </div>
                    </div>
                ...
                <div className='main_container flex lg:flex-row flex-col justify-between lg:items-end items-center lg:gap-12 gap-0'>
                    ...
                    <div className='lg:w-[45%] w-full left_line'>
                        ...
                        <div className="lg:mt-[30px] mt-5 text-center lg:text-left">
                            <a className="bg-light-white2 text-indigo lg:text-[18px] text-[15px] font-bold rounded-lg lg:px-6 px-5 lg:py-[14px] py-2">Start Today</a>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="main_container">
                    <div className="lg:w-[50%] w-full mx-auto text-center">
                        ...
                        <div className="lg:mt-[30px] mt-5">
                            <a className="bg-light-white2 text-indigo lg:text-[20px] text-[15px] font-bold rounded-lg lg:px-6 px-5 lg:py-[14px] py-2">Contact Us</a>
                        </div>
                    </div>
                </div>
            </section>
...
// can be reUsed
{/* <h2 className="inter lg:text-[28px] text-[15px] text-light-white2 font-normal"><span className="text-green lg:text-[37.5px] text-[15px] font-semibold">Embrace</span> the Future of HR Management <span className="lg:text-[37.5px] text-[15px] font-semibold">HRMS Fund Management</span></h2> */ }