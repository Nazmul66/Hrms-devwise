...
const CustomizableDashboard = () => {
  ...
  return (
    <>
      ...
      <div className={`${c.title}`}>Customizable Personal <span>Dashboard for your employee</span></div>
      <div className='mt-12'>
      ...
      <div className="lg:pt-20 lg:pb-20 pt-10 pb-28">
        <div className='main_container'>
          <h2 className="roboto lg:text-[36px] text-[22px] font-bold text-[#333] lg:leading-[48px] leading-[28px] text-center lg:mb-12 mb-8 lg:px-0 px-4">Customizable Personal <span className="text_gradient_personal">Dashboard for your employee</span></h2>
...
const cards = [
  {
    ...
    img: '/attendance.svg',
    img_stack: "/Home/stack_card_01.png",
    stack_card: "/Home/stack_cards/practical_01.png",
    lists: [
  ...
  },
  {
    ...
    img: '/Finances.svg',
    img_stack: "/Home/stack_card_02.png",
    stack_card: "/Home/stack_cards/practical_02.png",
    lists: [
      'Salary Insights',
      'Payroll Management',
      'Expense Tracking',
  ...
  },
  {
    ...
    img_stack: "/Home/stack_card_03.png",
    stack_card: "/Home/stack_cards/practical_03.png",
    lists: [
  ...
  },
  {
    ...
    img: '/tracking.svg',
    img_stack: "/Home/stack_card_04.png",
    stack_card: "/Home/stack_cards/practical_04.png",
    lists: [
  ...
  },
  {
    ...
    img_stack: "/Home/stack_card_05.png",
    stack_card: "/Home/stack_cards/practical_05.png",
    lists: [
  ...
  },
  {
    ...
    img_stack: "/Home/stack_card_06.png",
    stack_card: "/Home/stack_cards/practical_06.png",
    lists: [
      'Timely Updates',
  ...
  },
  {
    ...
    img_stack: "/Home/stack_card_07.png",
    stack_card: "/Home/stack_cards/practical_07.png",
    lists: [
