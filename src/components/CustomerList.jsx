...
const CustomerList = () => {
  ...
  const settings = {
    ...
    slidesToShow: 1,
    slidesToScroll: 1,
    nextArrow: <img src="/Home/arrow-right.png" />,
    prevArrow: <img src="/Home/arrow-left.png" />,
    arrows: true
  };
    ...
    <>
      ...
      <div className='mt-24 lg:block hidden'>
            ...
            <div className='flex items-center justify-between'>
              ...
              <div className='flex gap-20'>
                <div className='w-[193px] h-[193px] rounded-full flex items-center justify-center shadow-xl bg-[#FAFAFA]'>
                  <img src="/nivea.png" alt="nivea" className='w-[120px] h-[37px]' />
                </div>
                <div className='w-[193px] h-[193px] rounded-full flex items-center justify-center shadow-xl bg-[#FAFAFA]'>
                  <img src="/nourish.png" alt="nourish" className='w-[120px]' />
                </div>
              </div>
            </div>

            <img src="/hand-shake.png" alt="" className='relative z-10 w-[350px] h-[220px] left-[-75px]' />
          </div>
        </div>
        ...
        <div className={c.contentArea}>
          <div className='custom-container flex gap-28'>
            ...
            <div className='-translate-y-24'>
              <h1 className='text-white text-3xl font-medium mb-4'>Maximize Efficiency and Resource Optimization with <span className="text-primary">Techforing Workwise</span></h1>
              <p className="text opacity-75" style={{ color: 'white' }}>Whether you have 10 employees or 10,000 – the TechForing HRMS suite will elevate your workforce management with ease</p>
        ...
        <div className='relative z-0 card_sections'>
          <h3 className='text-4xl font-bold text-[#182F59] text-center mb-20'>Unleashing the Potential of Data with <span className='text-green'>Techforing Workwise</span></h3>
          <div className='custom-container'>
            ...
            <div className='w-[85%]'>
              <Slider {...settings}>
                ...
                <div className='!flex !justify-between !items-center !gap-20'>
                  <div className='w-[30%]'>
                    <img src="/Home/Walton.png" alt="" />
                  </div>
                  <div className='w-[70%]'>
                    <p className='roboto text-[#333] font-light leading-6 mb-5 pr-16'>Before implementing an HRMS (Human Resource Management System), our HR operations were complex, time-consuming, and prone to errors. However, since adopting our new HRMS, our experience has been nothing short of exceptional. </p>
                    <h2 className='roboto text-[28px] font-medium text-[#333] mb-1'>Jacob Jones</h2>
                    <span className='roboto text-[#333]'>Director, Walton Ltd.</span>
                  </div>
                </div>
          ...
          <div className='custom-container min-h-[212px] relative flex'>
            <div className='flex items-center'>
              ...
              <div className='w-8/12'>
                <span className=' text-white font-medium text-[28px] leading-8'>Don’t Settle for Less: Unlock the Full Potential of Your HR Department - With TechForing HRMS</span>
                <Button className='bg-green !w-fit mt-8' text='Schedule Live Demo' link='#' />
              </div>
            </div>
            <img src="/image 79 (1) 1 (1).png" alt="" className='absolute bottom-0 left-24 w-[169px] h-[276px]' />
          </div>
        </div>
      </div>
      ...
      <div className='lg:hidden block '>
        <div className='first_container pt-10 pb-28'>
          <div className='flex justify-between items-end gap-5 px-4'>
            <div className='w-[65%]'>
              ...
              <img src="/Home/hand-shake.png" alt="" className='translate-x-[-18px]' />
            </div>
            <div className='w-[35%] flex flex-col items-end'>
              <div className='w-[96px] h-[96px] rounded-full flex items-center justify-center shadow-xl bg-[#FAFAFA]'>
                <img src="/nivea.png" alt="nivea" className='w-[50px] lg:h-[50px] h-[20px]' />
              </div>
              <div className='w-[96px] h-[96px] translate-x-[-32px] mt-2 rounded-full flex items-center justify-center shadow-xl bg-[#FAFAFA]'>
                <img src="/nourish.png" alt="nourish" className='w-[50px] h-[50px]' />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='py-28 px-4 color_Change_bg mt-[-95px]'>
          <h2 className='roboto font-medium text-[20px] text-white mb-6'>Maximize Efficiency and Resource Optimization with <span className='text-green'>Techforing Workwise</span></h2>
          <p className='roboto text-[14px] leading-5 text-[#FAFAFA] opacity-75 mb-5'>Whether you have 10 employees or 10,000 – the TechForing HRMS suite will elevate your workforce management with ease</p>
                ...
                <li className='mb-5'>
                  <div className='flex justify-center mb-1'>
                    <div className='icon_glow bg-[#FF9300]'>
                      <img src="/Home/user.png" alt="" className='w-[20px]' />
                    </div>
                  </div>
                ...
                <li className='mb-5'>
                  <div className=' flex justify-center mb-1'>
                    <div className='icon_glow bg-[#5598EA]'>
                      <img src="/Home/cash.png" alt="" className='w-[20px]' />
                    </div>
                  </div>
                  <div className='leading-3'>
                ...
                <li className='mb-5'>
                  <div className=' flex justify-center mb-1'>
                    <div className='icon_glow bg-[#F282D9]'>
                      <img src="/Home/group.png" alt="" className='w-[20px]' />
                    </div>
                  </div>
                  <div className='leading-3'>
                ...
                <li className='mb-5'>
                  <div className=' flex justify-center mb-1'>
                    <div className='icon_glow bg-[#76D895]'>
                      <img src="/Home/time.png" alt="" className='w-[20px]' />
                    </div>
                  </div>
                  <div className='leading-3'>
              ...
              <ul>
                <li className='mb-6'>
                  <div className="flex items-center ml-5">
                    <img src="/Home/hand.png" alt="" className='' />
          ...
          <div className='text-center mt-4'>
            <a href='' className='roboto font-bold bg-green text-white rounded-lg px-7 py-[10px]'>Get Demo</a>
          </div>
        </div>
        ...
        <div className='last_container_bg pt-7'>
          <div className='px-4'>
            <h2 className='roboto font-bold text-[18px] leading-[22px] text-[#182F59] text-center mb-5'>Unleashing the Potential of Data with <span className='text-green'>Techforing Workwise</span></h2>
            ...
            <div className='w-full'>
              <Slider {...settings}>
                ...
                <div className='!flex !flex-col !justify-between !items-center lg:!gap-20 !gap-0'>
                  <div className='w-full'>
                    <img src="/Home/Walton.png" alt="" className='w-[240px] lg:mx-0 mx-auto' />
                  </div>
                  <div className=' w-full'>
                    <p className='roboto text-[#333] lg:text-left font-normal leading-7 mb-5 lg:pr-16 pr-0 text-justify'>Before implementing an HRMS (Human Resource Management System), our HR operations were complex, time-consuming, and prone to errors. However, since adopting our new HRMS, our experience has been nothing short of exceptional. </p>
                    <h2 className='text-center lg:text-left roboto text-[28px] font-medium text-[#333] mb-1'>Jacob Jones</h2>
                    <span className='block text-center lg:text-left roboto text-[#333]'>Director, Walton Ltd.</span>
                  </div>
                </div>
        ...
        <div className='bg-[#182F59] py-8 px-4 mt-32 mb-16 relative'>
          <div className='w-[50%] ml-auto'>
            <span className='text-white text-[12px] font-medium leading-5 mb-6 block'>Don’t Settle for Less: Unlock the Full Potential of Your HR Department - With TechForing HRMS</span>
            <div className='lg:text-center text-left'>
              <a className='action_btn px-6 py-[10px] text-[12px] rounded-lg' >Schedule Live Demo</a>
            </div>
          </div>

          <img src="/image 79 (1) 1 (1).png" alt="" className='absolute bottom-0 left-3 w-[155px]' />
        </div>
      </div>
    </>
  )
