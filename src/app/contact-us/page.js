...
import BitrixFormScript from '@/components/BitrixFormScript'
    ...
    <>
      ...
      <div className="custom-container">
        ...
        <div className='flex lg:flex-row flex-col gap-6 w-full'>
          <div className='lg:min-w-[476px] min-w-full border p-6 lg:flex flex-col gap-6' style={{
            border: '1px solid #D9D9D9',
            borderRadius: '12px'
          }}>
            <h3 className='text-secondary-1 font-bold lg:text-3xl text-2xl'>Speak With Expert Team</h3>
            <div className='flex flex-col gap-4'>
              <div className='flex items-center gap-6 mt-10'>
                <div className='w-8 h-8 bg-primary rounded-full flex items-center justify-center'>
                  <Clock width='16px' color1="#fff" color2='#fff' />
                </div>
                <div className=''>
                  <h3 className='lg:text-[16px] text-[14px]'><span className='text-[#333] opacity-70'>Week Day’s :</span> <span className='text-light-gray'>&nbsp; &nbsp; &nbsp;Sunday - Thursday </span></h3>
                  <h3 className='lg:text-[16px] text-[14px]'><span className='text-[#333] opacity-70'>Time :</span> <span className='text-light-gray'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;10 am - 6 pm</span></h3>
                </div>
              </div>
              ...
              <div className='flex items-center gap-6'>
                <div className='w-8 h-8 bg-primary rounded-full flex items-center justify-center'>
                  <BsFillTelephoneFill className='w-4 text-white' />
                </div>
                <p className='text-dark-text-2 tex-[14px] lg:text-[16px]'>+1 616 271 8544</p>
              </div>
              <Divider style={{
                width: '100%',
                background: 'linear-gradient(90deg, rgba(255,255,255,0) 0%, rgba(0,0,0,1) 50%, rgba(255,255,255,0) 100%)',
              ...
              <div className='flex items-center gap-6'>
                <div className='w-8 h-8 bg-primary rounded-full flex items-center justify-center'>
                  <AiOutlineMail className='w-4 text-white' />
                </div>
                <p className='text-dark-text-2 tex-[14px] lg:text-[16px]'>info@techforing.com</p>
              </div>
            </div>
            <div className='relative w-full lg:h-[401px] h-[320px] mt-7'>
              <img className='lg:absolute relative object-cover' src='/contact.png' alt='call center' />
            </div>
          </div>
          <div className='w-full p-6' style={{
            ...
            <h3 className='text-secondary-1 font-bold text-3xl'>Have a <span className='text-primary'>Question?</span></h3>
            <p className='mt-4'>
              If you have any queries about our pricing, looking for a live demo, or have any other questions, please email us using the form below
            </p>
            <script
              dangerouslySetInnerHTML={{
                __html: `
                (function(w,d,u){var s=d.createElement('script');s.async=true;s.src=u+'?'+(Date.now()/180000|0);var h=d.getElementsByTagName('script')[0];h.parentNode.insertBefore(s,h);})(window,document,'https://cdn.bitrix24.com/b15773863/crm/form/loader_446.js')
                `,
              }}
            />
          </div>
            ...
            <div className='lg:w-5/12 w-full bg-[#FAFAFA] rounded-lg p-[6px] flex flex-col gap-14'>
              ...
              <div className='grid lg:grid-cols-3 grid-cols-2 gap-2 text-black p-2'>
                ...
                <div className={`${active === 'TURKEY' ? 'bg-primary bg-opacity-50 transition-all' : 'bg-white'}  rounded-md flex items-center p-4 shadow-md cursor-pointer`}
                  ...
                  <img src='/turkey.png' className='w-6 h-6' alt='turkey' />
                ...
                <div className={`${active === 'IND' ? 'bg-primary bg-opacity-50 transition-all' : 'bg-white'}  rounded-md flex items-center p-4 shadow-md cursor-pointer`}
                  ...
                  <img src='/india.png' className='w-6 h-6' alt='india' />
