...
const Cash_flow = () => {
    ...
    const manual_resource = {
        ...
        img1 : "/Finance/Cash_flow/icons/analysis.png",
        img2 : "/Finance/Cash_flow/icons/time.png",
        img3 : "/Finance/Cash_flow/icons/setting_time.png",
        img4 : "/Finance/Cash_flow/icons/file_list.png",
        img5 : "/Finance/Cash_flow/icons/calculator.png",
        manualImage : "/Finance/Cash_flow/Finance_cash_flow.png",
    ...
    const details01 = {
        ScreenShot: '/Finance/Cash_flow/screenshot_1.png',
    ...
    const details02 = {
        ScreenShot: '/Finance/Cash_flow/screenshot_2.png',
    ...
    return (
        <>
                ...
                <div className='main_container flex lg:flex-row flex-col-reverse justify-between items-center'>
                    ...
                    <div className="lg:w-[55%] w-full flex lg:flex-row flex-col justify-end lg:mb-0 mb-12">
                        ...
                        <div className='lg:w-[530px] w-[200px] lg:mx-0 mx-auto lg:h-[395px] h-full relative'>
                            <img src="/Finance/Cash_flow/combine_image/blob.png" alt="" /> 
                            <img src="/Finance/Cash_flow/combine_image/person.png" alt="" className='absolute lg:bottom-[5px] bottom-[1px] left-[50%] translate-x-[-50%]'/>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="main_container">
                    ...
                    <div className="flex lg:flex-row flex-col justify-between gap-8">
                       <div className="lg:w-[50%] w-full lg:py-[50px] py-5 lg:px-[100px] px-8 bg_angular">
                          <img src="/Finance/Cash_flow/cash_flow_overview.png" alt="" className="block mx-auto multiShadow mb-5" />
                       ...
                       <div className="lg:w-[50%] w-full lg:py-[50px] py-5 lg:px-[100px] px-8 bg_angular">
                          <img src="/Finance/Cash_flow/cash_flow_report.png" alt="" className="block mx-auto multiShadow mb-5" />
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/Cash_flow/screenshot_1.png" alt="" className='w-full h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden lg:mb-20 mb-8'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-25px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/Cash_flow/screenshot_2.png" alt="" className='[670px] h-[380px] lg:object-contain object-none absolute top-[50%] translate-y-[-50%]' />
                    </div> 
                ...
                <div className="main_container flex justify-between items-center lg:py-[80px] py-[20px] px-4 relative">
                    <div className="w-[51%] lg:pl-[18px] pl-0">
                        ...
                        <div className="lg:mt-10 mt-5 text-left">
                            <a href="" className="action_btn text-[16px] lg:px-[28px] px-[18px] lg:py-2 py-[6px]">Schedule A Consultation</a>
                        </div>
                    </div>

                    <div className="image_container2 lg:translate-x-[110px] translate-x-0">
                        <img src="/Finance/Cash_flow/CashFlow_business_team.png" alt="" className="w-ful h-full" />
                    </div>
                </div>
            </section>
            ...
            <section className="footer_bottom_cta_cash_flow">
                <div className="main_container">
                    <div className="lg:w-[70%] w-full mx-auto text-center">
                    <img src="/Finance/Cash_flow/footer_bottom_cta.png" alt="" className="block mx-auto mb-5 lg:w-[198px] w-[100px]" />
                    <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 font-semibold lg:mb-2 mb-2">Take <span className="text-green font-semibold">Control</span> of Your Cash Flow!</h2>
                    <p className="lg:text-[18px] text-[12px] lg:font-semibold font-normal inter text-light-white2"> Experience streamlined financial management like never before</p>
