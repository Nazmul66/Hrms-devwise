...
const Financial_report = () => {
    ...
    const manual_resource = {
        ...
        img1 : "/Finance/finance_report/icons/file_err.png",
        img2 : "/Finance/finance_report/icons/time.png",
        img3 : "/Finance/finance_report/icons/doc_err.png",
        img4 : "/Finance/finance_report/icons/pie_cash.png",
        img5 : "/Finance/finance_report/icons/money_decrease.png",
        manualImage : "/Finance/finance_report/Finance_report.png",
    ...
    const details01 = {
        ScreenShot: '/Finance/finance_report/screenshot_1.png',
    ...
    const details02 = {
        ScreenShot: '/Finance/finance_report/screenshot_2.png',
        ...
        content02: "WorkWise’s Expense Report feature simplifies expense tracking and analysis. It provides instant insights into expense categories, compares year-to-year spending, and generates detailed monthly reports automatically."
    }

    const details03 = {
        ScreenShot: '/Finance/finance_report/screenshot_3.png',
    ...
    return (
        <>
                ...
                <div className='main_container flex lg:flex-row flex-col-reverse justify-between items-center'>
                    ...
                    <div className="lg:w-[55%] w-full flex lg:flex-row flex-col justify-end lg:mb-0 mb-12">
                        ...
                        <div className='lg:w-[530px] w-[200px] lg:mx-0 mx-auto lg:h-[395px] h-full relative'>
                            <img src="/Finance/finance_report/combine_image/blob.png" alt="" /> 
                            <img src="/Finance/finance_report/combine_image/person.png" alt="" className='absolute lg:bottom-[5px] bottom-[1px] left-[50%] translate-x-[-50%]'/>
                        </div>
                    </div>
                </div>
            </section>
            ...
            {/* 4th individual section start */}
              <section className='lg:py-10 py-5 lg:bg-transparent bg-light-white px-4 lg:mb-0 mb-20'>
                 <div className='main_container'>
                     <div className="lg:mb-16 mb-10">
                        ...
                        <div className='lg:w-[600px] w-full lg:h-[600px] h-full mx-auto lg:bg-[#F6F6F6] bg-transparent rounded-full relative lg:mb-0 mb-5'>
                           ...
                           <img src="/Finance/finance_report/analysis.png" alt="" className='mx-auto relative z-10' />
                        </div>
            ...
            <section className='finance_report_organized lg:mb-16 mb-8'>
                ...
                <div className='middle_hr mt-3 mb-4'></div>
                    ...
                    <div className='lg:w-[45%] w-full left_line'>
                        ...
                        <div className="lg:mt-[30px] mt-5 lg:text-left text-center">
                            <a className="action_btn2 lg:px-7 px-5 lg:py-[12px] py-2">Get A Live Demo</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden lg:mb-10 mb-0'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/finance_report/screenshot_1.png" alt="" className='w-full h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden lg:mb-10 mb-8'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-20px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/finance_report/screenshot_2.png" alt="" className='w-full h-full lg:object-contain object-none' />
                    </div> 
            ...
            <section className="bg-[#FAFAFA] shadow-shadow1x text-[#FAFAFA] lg:mt-20 lg:mb-20 mt-0 mb-5 overflow-hidden">
                <div className="main_container flex justify-between items-center lg:py-[110px] py-[20px] px-4 relative">
                    <div className="lg:w-[51%] w-[50%] lg:ml-auto ml-0 lg:pl-[120px] pl-0">
                       <h3 className="inter font-extralight lg:text-[37.5px] text-[15px] mb-3 text-left lg:leading-[48px] leading-[22px]"><span className='text_gradient_finance'>Say </span><span className='text-green font-semibold'>Goodbye</span><span className='text_gradient_finance'> to Manual Report Management!</span></h3> 
                        ...
                        <div className="lg:mt-10 mt-5 text-left">
                            <a href="" className="action_btn lg:text-[18px] text-[16px] lg:px-[28px] px-[14px]  py-2">Schedule A Consultation</a>
                        </div>
                    </div>

                    <div className="image_container_unique lg:translate-x-[-110px] translate-x-[-80%]">
                        <img src="/Finance/finance_report/finance_report_business_team.png" alt="" className="w-full h-full" />
                    </div>
                </div>
            </section>
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/finance_report/screenshot_3.png" alt="" className='w-[600px] h-[480px]' />
                    </div>
                </div>
            </section>
            ...
            <section className="footer_bottom_cta_f_report">
                <div className="main_container">
                    <div className="lg:w-[70%] w-full mx-auto text-center">
                    <img src="/Finance/finance_report/footer_bottom_cta.png" alt="" className="block mx-auto mb-5 lg:w-[198px] w-[100px]" />
                    <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 font-semibold lg:mb-2 mb-2">Ready to <span className="text-green font-semibold">Simplify</span> Financial Reporting?</h2>
                    <p className="lg:text-[18px] text-[12px] lg:font-semibold font-normal inter text-light-white2">Get better financial insights easily and empower your HR team Today!</p>
