...
const Budget_management = () => {
    ...
    const manual_resource = {
        ...
        img1 : "/Finance/Budget_management/icons/time.png",
        img2 : "/Finance/Budget_management/icons/calculator.png",
        img3 : "/Finance/Budget_management/icons/sync_group.png",
        img4 : "/Finance/Budget_management/icons/particles.png",
        img5 : "/Finance/Budget_management/icons/settings.png",
        manualImage : "/Finance/Budget_management/Finance_budget_management.png",
    ...
    const details01 = {
        ScreenShot: '/Finance/Budget_management/screenshot_1.png',
    ...
    const details02 = {
        ScreenShot: '/Finance/Budget_management/screenshot_2.png',
    ...
    const details03 = {
        ScreenShot: '/Finance/Budget_management/screenshot_3.png',
    ...
    const details04 = {
        ScreenShot: '/Finance/Budget_management/screenshot_4.png',
        ...
        content02: "Workwise offers a Budget Comparison feature, allowing HR professionals to select different budget entries and instantly compare them. This helps them to quickly identify discrepancies, optimize resource allocation, and make data-driven decisions; enabling more efficient budget planning and tracking further down the road."
    }
        ...
        <>
                ...
                <div className='main_container flex lg:flex-row flex-col-reverse justify-between items-center'>
                    ...
                    <div className="lg:w-[55%] w-full flex lg:flex-row flex-col justify-end lg:mb-0 mb-12">
                        ...
                        <div className='lg:w-[530px] w-[200px] lg:mx-0 mx-auto lg:h-[395px] h-full relative'>
                            <img src="/Finance/Budget_management/combine_image/blob.png" alt="" /> 
                            <img src="/Finance/Budget_management/combine_image/person.png" alt="" className='absolute lg:bottom-[5px] bottom-[1px] left-[50%] translate-x-[-50%]'/>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='lg:block hidden py-[60px]'>
                ...
                <div className='main_container flex justify-between items-center gap-8'>
                    ...
                    <img src="/Finance/Budget_management/growth_team.png" alt="" className="shadow-shadow3.5x" />
                    </div>
            ...
            <div className='px-4 py-10 lg:hidden block mb-16 overflow-hidden'>
                ...
                <div className='relative mb-10'>
                    <img src="/Finance/Budget_management/growth_team.png" alt="" className="shadow-shadow3.5x relative z-10" />
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden lg:mb-20 mb-0'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/Budget_management/screenshot_1.png" alt="" className='w-full h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden lg:mb-10 mb-8'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-20px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/Budget_management/screenshot_2.png" alt="" className='w-[580px] h-full lg:object-contain object-none' />
                    </div> 
            ...
            <section className='next_level px-4 relative lg:py-0 py-5 lg:mb-10 mb-0 lg:mt-14 mt-8'>
                ...
                <div className='main_container flex justify-between items-center'>
                    ...
                    <img src="/Finance/Budget_management/person-2.png" alt="" className='w-[420px] mx-auto' />
                    </div>
                </div>
            </section>
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden'>
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/Budget_management/screenshot_3.png" alt="" className='w-[540px] h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className='lg:py-[100px] py-[40px] px-4 overflow-hidden lg:mb-10 mb-0'>
                <div className='main_container flex_container relative'>
                    <div className='absolute top-[50%] left-0 w-[40%] h-[150%] bg-[#EAEAEA] translate-x-[-100px] translate-y-[-50%] border_top_right_radius lg:block hidden'></div>
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-20px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Finance/Budget_management/screenshot_4.png" alt="" className='w-[580px] h-full lg:object-contain object-none' />
                    </div> 
            ...
            <section className="footer_bottom_cta_budget">
                <div className="main_container">
                    <div className="lg:w-[70%] w-full mx-auto text-center">
                    <img src="/Finance/Budget_management/footer_bottom_cta.png" alt="" className="block mx-auto mb-5 lg:w-[198px] w-[100px]" />
                    <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 font-semibold lg:mb-2 mb-2"><span className="text-green font-semibold">Boost</span> Financial Efficiency</h2>
                    <p className="lg:text-[18px] text-[12px] lg:font-semibold font-normal inter text-light-white2">Take Control of Your Organization’s Finances With Easy Budgeting</p>
