...
const Asset = () => {
    ...
    const manual_resource = {
        ...
        img1 : "/Finance/Asset/icons/pc_doc.png",
        img2 : "/Finance/Asset/icons/doc_err.png",
        img3 : "/Finance/Asset/icons/calculator.png",
        img4 : "/Finance/Asset/icons/doc_secure.png",
        img5 : "/Finance/Asset/icons/yes_no.png",
        manualImage : "/Finance/Asset/Finance_asset.png",
    ...
    return (
        <>
                ...
                <div className='main_container flex lg:flex-row flex-col-reverse justify-between items-center'>
                    ...
                    <div className="lg:w-[55%] w-full flex lg:flex-row flex-col justify-end lg:mb-0 mb-12">
                        ...
                        <div className='lg:w-[530px] w-[200px] lg:mx-0 mx-auto lg:h-[395px] h-full relative'>
                            <img src="/Finance/Asset/combine_image/blob.png" alt="" /> 
                            <img src="/Finance/Asset/combine_image/person.png" alt="" className='absolute lg:bottom-[5px] bottom-[1px] left-[50%] translate-x-[-50%]'/>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="pt-5 pb-[60px] px-4 lg:hidden block">
                ...
                <Swiper
                    ...
                    <div className="pb-[60px]">
                        <div className="p-5 angular_gradient border-[#182F59] border-l-2 rounded-lg mb-5">
                            <div className="flex items-center mb-3">
                                <img src="/Finance/Asset/icons/Group_01.png" alt="" />
                        ...
                        <div className="p-5 angular_gradient border-[#182F59] border-l-2 rounded-lg">
                            <div className="flex items-center mb-3">
                                <img src="/Finance/Asset/icons/Group_02.png" alt="" />
                    ...
                    <div className="pb-[60px]">
                            <div className="p-5 angular_gradient border-[#182F59] border-l-2 rounded-lg mb-5">
                                <div className="flex items-center mb-3">
                                    <img src="/Finance/Asset/icons/Group_03.png" alt="" />
                            ...
                            <div className="p-5 angular_gradient border-[#182F59] border-l-2 rounded-lg">
                                <div className="flex items-center mb-3">
                                    <img src="/Finance/Asset/icons/Group_04.png" alt="" />
                    ...
                    <div className="pb-[60px]">
                            <div className="p-5 angular_gradient border-[#182F59] border-l-2 rounded-lg mb-5">
                                <div className="flex items-center mb-3">
                                    <img src="/Finance/Asset/icons/Group_05.png" alt="" />
                            ...
                            <div className="p-5 angular_gradient border-[#182F59] border-l-2 rounded-lg">
                                <div className="flex items-center mb-3">
                                    <img src="/Finance/Asset/icons/Group_06.png" alt="" />
            ...
            <section className='asset_organized lg:mt-20 mt-0 lg:mb-16 mb-8'>
                ...
                <div className='middle_hr mt-4 mb-4'></div>
                    ...
                    <div className='lg:w-[45%] w-full left_line'>
                        ...
                        <div className="lg:mt-[40px] mt-5 lg:text-left text-center">
            ...
            <section className='lg:block hidden'>
              <div className='max-w-[1000px] mx-auto'>
                 <div className='mb-10'>
                    ...
                    <p className="px-20 mb-10 font-light leading-[26px] text-light-gray text-center">Lorem ipsum dolor sit amet consectetur. Ornare pharetra cursus ut ut eu amet at. Volutpat etiam adipiscing vitae semper mauris. Dui habitant urna eget hendrerit a quam sed mi. At feugiat nibh sit adipiscing iaculis.</p>
                 </div>
                        ...
                        <div className='bg-white px-[50px] py-[65px] flex justify-between items-center rounded-tl-[200px] rounded-bl-[200px]'>
                             <div className='w-[30%]'> 
                                <div className='w-[200px] h-[200px] rounded-full bg-light-white flex justify-center items-center'>
                                   <div className='w-[160px] h-[160px] bg-light-white2 rounded-full flex justify-center items-center'>
                                       <img src="/Finance/Asset/pc_setting.png" alt="" />
                                   </div>
                                </div>
                             </div>
                             ...
                             <div className='lg:w-[70%] w-full'>
                                <div className='flex items-center mb-[30px] lg:mr-[60px] mr-0'>
                                    <img src="/Finance/icons/stroke_color.png" alt="" />
                                ...
                                <div className='content_div'>
                                    ...
                                    <div className='para_div'>
                                        <img src="/Finance/icons/fill_like.png" alt="" />
                     ...
                     <div className='rounded-tr-[200px] rounded-br-[200px] gradient_transparent_div2 pb-[2px] pt-[2px] pr-[2px]'>
                        <div className='bg-white px-[50px] py-[65px] flex justify-between items-center rounded-tr-[200px] rounded-br-[200px]'>
                             ...
                             <div className='w-[30%] flex items-center justify-end'> 
                                <div className='w-[200px] h-[200px] rounded-full bg-light-white flex justify-center items-center'>
                                   <div className='w-[160px] h-[160px] bg-light-white2 rounded-full flex justify-center items-center'>
                                       <img src="/Finance/Asset/analysis_time.png" alt="" />
                                   </div>
                                </div>
                             </div>
                        </div>
                     ...
                     <div className='rounded-tl-[200px] rounded-bl-[200px] gradient_transparent_div pb-[2px] pt-[2px] pl-[2px]'>
                        <div className='bg-white px-[50px] py-[65px] flex justify-between items-center rounded-tl-[200px] rounded-bl-[200px]'>
                             <div className='w-[30%]'> 
                                <div className='w-[200px] h-[200px] rounded-full bg-light-white flex justify-center items-center'>
                                   <div className='w-[160px] h-[160px] bg-light-white2 rounded-full flex justify-center items-center'>
                                       <img src="/Finance/Asset/doc_plus.png" alt="" />
                                   </div>
                                </div>
                             </div>
                     ...
                     <div className='rounded-tr-[200px] rounded-br-[200px] gradient_transparent_div2 pb-[2px] pt-[2px] pr-[2px]'>
                        <div className='bg-white px-[50px] py-[65px] flex justify-between items-center rounded-tr-[200px] rounded-br-[200px]'>
                             ...
                             <div className='w-[30%] flex items-center justify-end'> 
                                <div className='w-[200px] h-[200px] rounded-full bg-light-white flex justify-center items-center'>
                                   <div className='w-[160px] h-[160px] bg-light-white2 rounded-full flex justify-center items-center'>
                                       <img src="/Finance/Asset/tree.png" alt="" />
                                   </div>
                                </div>
                             </div>
                        </div>
                     ...
                     <div className='rounded-tl-[200px] rounded-bl-[200px] gradient_transparent_div pb-[2px] pt-[2px] pl-[2px]'>
                        <div className='bg-white px-[50px] py-[65px] flex justify-between items-center rounded-tl-[200px] rounded-bl-[200px]'>
                             <div className='w-[30%]'> 
                                <div className='w-[200px] h-[200px] rounded-full bg-light-white flex justify-center items-center'>
                                   <div className='w-[160px] h-[160px] bg-light-white2 rounded-full flex justify-center items-center'>
                                       <img src="/Finance/Asset/doc_lock.png" alt="" />
                                   </div>
                                </div>
                             </div>
            ...
            <section className="footer_bottom_cta_asset">
                <div className="main_container">
                    <div className="lg:w-[70%] w-full mx-auto text-center">
                    <img src="/Finance/Asset/footer_bottom_cta.png" alt="" className="block mx-auto mb-5 lg:w-[198px] w-[100px]" />
                    <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 font-semibold lg:mb-2 mb-2">Ready to <span className="text-green font-semibold">Upgrade</span> Asset Management?</h2>
                    <p className="lg:text-[18px] text-[12px] lg:font-semibold font-normal inter text-light-white2">Transform Asset Management and Reach Maximum HR Efficiency Today!</p>
