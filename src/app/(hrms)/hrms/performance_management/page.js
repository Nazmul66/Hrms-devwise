...
const Performance_management = () => {
    ...
    const manual_resource = {
        ...
        img1: "/HRMS/performance_management/icons/ratio.png",
        img2: "/HRMS/performance_management/icons/list.png",
        img3: "/HRMS/performance_management/icons/search_err.png",
        img4: "/HRMS/performance_management/icons/pc_opt.png",
        img5: "/HRMS/performance_management/icons/user_circle.png",
        manualImage: "/HRMS/performance_management/HRMS_performance_management.png",
    ...
    const status_details = [
        {
            _id: 1,
            img: "/HRMS/performance_management/icons/group_01.png",
        ...
        {
            _id: 2,
            img: "/HRMS/performance_management/icons/group_02.png",
        ...
        {
            _id: 3,
            img: "/HRMS/performance_management/icons/group_03.png",
        ...
        {
            _id: 4,
            img: "/HRMS/performance_management/icons/group_04.png",
        ...
        {
            _id: 5,
            img: "/HRMS/performance_management/icons/group_05.png",
        ...
        {
            _id: 6,
            img: "/HRMS/performance_management/icons/group_06.png",
        ...
        {
            _id: 7,
            img: "/HRMS/performance_management/icons/group_07.png",
        ...
        {
            _id: 8,
            img: "/HRMS/performance_management/icons/group_08.png",
        ...
        <>
                ...
                <div className='main_container flex lg:flex-row flex-col-reverse justify-between items-center'>
                    ...
                    <div className="lg:w-[55%] w-full lg:flex-row flex-col flex justify-end lg:mb-0 mb-16">
                        ...
                        <div className='lg:w-[530px] w-[200px] lg:mx-0 mx-auto lg:h-[395px] h-full relative'>
                            <img src="/HRMS/performance_management/combine_image/blob.png" alt="" />
                            <img src="/HRMS/performance_management/combine_image/main-frame.png" alt="" className={`main_frame ${isAnimated ? 'animate' : ''}`} />
                            <img src="/HRMS/performance_management/combine_image/person.png" alt="" className='absolute bottom-1 left-[50%] translate-x-[-50%]' />
                            <img src="/HRMS/performance_management/combine_image/Frame-1.png" alt="" className={`performance_Frame_1 absolute lg:w-[172px] w-[100px] lg:bottom-[55px] bottom-0 lg:left-[65px] left-[24px] ${frame1 ? 'animate' : ''}`} />
                            <img src="/HRMS/performance_management/combine_image/Frame-2.png" alt="" className={`performance_Frame_2 absolute lg:w-[172px] w-[100px] lg:bottom-[26px] bottom-[-26px] lg:right-[80px] right-[0px] ${frame2 ? 'animate' : ''}`} />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="lg:pt-20 pt-3 lg:pb-16 pb-16 px-4">
                <div className="main_container">
                    ...
                    <p className="lg:mb-16 mb-10 leading-6 text-light-gray lg:px-16 px-0 lg:text-center text-justify">TechForing WorkWise simplifies HR processes by automating data collection, providing real-time insights, tracking employee performance, and rewarding your employees accordingly.</p>

                    <div className="flex lg:flex-row flex-col justify-between gap-8">
                        <div className="lg:w-[50%] w-full lg:py-[50px] py-5 lg:px-[100px] px-8 bg_angular">
                            <img src="/HRMS/performance_management/kpi.png" alt="" className="block mx-auto multiShadow mb-5" />
                        ...
                        <div className="lg:w-[50%] w-full lg:py-[50px] py-5 lg:px-[100px] px-8 bg_angular">
                            <img src="/HRMS/performance_management/success.png" alt="" className="block mx-auto multiShadow mb-5" />
            ...
            <section className='performance_organized lg:my-[60px] my-8'>
                <div className='main_container flex lg:flex-row flex-col justify-between lg:items-end items-center lg:gap-12 gap-0'>
                    ...
                    <div className='lg:w-[45%] w-full left_line'>
                        ...
                        <div className="lg:mt-[30px] mt-5 text-center lg:text-left">
                            <a className="action_btn2 rounded-lg lg:px-6 px-5 lg:py-[14px] py-2">Start Today !</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="lg:pt-10 pt-3 lg:pb-16 pb-0 px-4">
                <div className="main_container">
                    <h2 className="lg:text-center text-left inter lg:mb-8 mb-5 lg:text-[36px] text-[20px] font-bold lg:leading-[50px] leading-8 text_gradient">Performance Management with KPI Scores and Bonuses</h2>
                    <p className="lg:mb-16 mb-10 leading-6 text-light-gray lg:px-16 px-0 lg:text-center text-justify">Efficiently motivate, track, and reward high-performing employees with our KPI score and Bonuses Module. This system ensures transparency, identifies top performers, and encourages continuous improvement. Boost morale and drive success in your organization</p>
                    ...
                    <div className="flex lg:flex-row flex-col-reverse justify-between items-center gap-5">
                        <div className="lg:w-[50%] w-full">
                            <ul>
                                <li className="flex lg:items-end items-center lg:mb-6 mb-5">
                                    <img src="/HRMS/icons/color_like.png" alt="" />
                        ...
                        <div className="lg:w-[50%] w-full">
                            <img src="/HRMS/performance_management/screenshot_1.png" className="block mb-5" alt="" />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='lg:pt-[20px] lg:pb-[20px] pt-[50px] pb-0 px-4 overflow-hidden lg:mb-16 mb-0'>
                <div className="main_container">
                    <div className="lg:w-[90%] w-full lg:mb-40 mb-0 mx-auto">
                        ...
                        <div className="flex items-center mb-[30px] lg:mr-[60px] mr-0">
                            <img src="/HRMS/performance_management/icons/stroke_like.png" alt="" className="lg:block hidden" />
                    ...
                    <div className='flex lg:flex-row flex-col justify-between relative'>
                        ...
                        <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-25px] left-0 w-[640px] h-[440px] lg:block hidden'>
                            <img src="/HRMS/performance_management/screenshot_2.png" alt="" className='w-full h-full lg:object-contain object-none' />
                        </div>
                        ...
                        <div className="h-[250px] grid grid-cols-1 items-center relative z-[1] mb-10 lg:hidden block">
                            ...
                            <img src="/HRMS/performance_management/screenshot_2.png" alt="" className="w-[300px] mx-auto object-cover relative z-10" />
                        </div>
                        ...
                        <div className='lg:w-[50%] lg:ml-auto ml-0 w-full lg:translate-x-[42px] translate-x-0'>
                            <ul>
                                <li className="flex lg:items-end items-center lg:mb-6 mb-5">
                                    <img src="/HRMS/icons/color_like.png" alt="" />
                                    <p className="text-light-gray font-light ml-6 lg:mt-3 mt-0 lg:text-[16px] text-[14px]">Automate and simplify the promotion process with WorkWise</p>
                                </li>
                                <li className="flex lg:items-end items-center lg:mb-6 mb-5">
                                    <img src="/HRMS/icons/color_like.png" alt="" />
            ...
            <section className='next_level px-4 relative lg:py-0 py-5 lg:mb-20 mb-0 lg:mt-0 mt-8'>
                ...
                <div className='main_container flex justify-between items-center'>
                    ...
                    <div className="w-[48%] lg:block hidden">
                        <img src="/HRMS/performance_management/person-2.png" alt="" className='w-[420px] mx-auto' />
                    </div>
                </div>
            </section>
            ...
            <section className="pt-16 px-4 lg:hidden block">
                <h2 className="inter font-bold text-[20px] leading-22px] text_gradient mb-4 ">Effortless Employee Management</h2>
                <p className="mb-20 font-light leading-[24px] text-light-gray">WorkWise Employee Management Module is a sophisticated solution, designed to ease your HR processes with a comprehensive suite of essential features</p>
                <Swiper
                    slidesPerView={1}
                    spaceBetween={10}
                    pagination={{
                            ...
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_01.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="pb-10">
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_02.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="pb-10">
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_03.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="pb-10">
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_04.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="pb-10">
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_05.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="pb-10">
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_06.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="pb-10">
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_07.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="pb-10">
                            <div className="flex flex-col items-center gap-2 mb-7">
                                <div className="">
                                    <div className="w-[120px] h-[120px] shadow-shadow2.5x flex justify-center items-center">
                                        <img src="/HRMS/performance_management/icons/group_08.png" alt="" className="w-[60px]" />
                                    </div>
                                </div>
            ...
            <section className="footer_bottom_cta_performance">
                <div className="main_container">
                    <div className="lg:w-[70%] w-full mx-auto text-center">
                        <img src="/HRMS/performance_management/footer_bottom_cta.png" alt="" className="block mx-auto mb-5 lg:w-[198px] w-[100px]" />
                        <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 font-normal">Get a Clear Picture of Your </h2>
                        <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 lg:mt-[-8px] mt-1 font-normal">Organization’s <span className="text-green font-semibold">Performance</span> Today</h2>
