...
const Recruitment = () => {
        ...
        function setActiveLink(index) {
            text_highlight.forEach((link, i) => {
                if (i === index) {
                    ...
                    icons[i].src = "/Recruitment/icons/fill_arrow.png";
                }
                else {
                    text_highlight[i].classList.remove('textActive');
                    icons[i].src = "/Recruitment/icons/stroke_arrow.png";
                }
            });
        }
    ...
    const manual_resource = {
        ...
        img1: "/Recruitment/icons/time.png",
        img2: "/Recruitment/icons/doc_setting.png",
        img3: "/Recruitment/icons/time_alert.png",
        img4: "/Recruitment/icons/yes_no.png",
        img5: "/Recruitment/icons/like_dislike.png",
        manualImage: "/Recruitment/Recruitment.png",
    ...
    const details = {
        ScreenShot: '/Recruitment/screenshot_1.png',
    ...
    return (
        <>
                ...
                <div className='flex items-center'>
                    <div className='w-[33.33%]'>
                        <div className='w-full recruitment_gradient relative py-[15px] px-3' onClick={() => setDrop(!drop)}>
                            <span className='text-[#FFF] font-medium'>Recruitment</span>
            ...
            <nav className='lg:block hidden sticky top-[75px] z-50 mb-24 mt-20'>
                <div className='max-w-[1200px] mx-auto'>
                    <ul className="bg-light-white2 text-center grid grid-cols-5 shadow-shadow4.5x rounded-lg">
                        {
                            route_pages.map(({ img, svg, content, link }, index) => (
                                <li key={index} className='recruitment_list_element'>
                    ...
                    <div className='flex justify-between items-center'>
                        <div className="w-[50%]">
                            <div className='text_highlight shadow-shadow5x px-7 py-5 rounded-md w-[530px] mb-5 bg-white'>
                                ...
                                <div className='flex items-center'>
                                    <img src="/Recruitment/icons/stroke_arrow.png" alt="" className='icons' />
                        ...
                        <div className="w-[50%]">
                            <img src="/Recruitment/next_lvl_recruit.png" alt="" className='shadow-shadow5.5x' />
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="pt-16 pb-[80px] px-4 lg:hidden block">
                ...
                <img src="/Recruitment/next_lvl_recruit.png" alt="" className='mb-8' />
                            ...
                            <div className="pb-8">
                                <div className='text_highlight shadow-shadow5x px-7 py-5 mx-4 rounded-md mb-5 bg-white'>
                                    ...
                                    <div className='flex items-center mb-4'>
                                        <img src="/Recruitment/icons/fill_arrow.png" alt="" className='icons' />
            ...
            <section className='scrollSection relative lg:pt-[160px] lg:pb-[100px] pt-[40px] pb-[40px] px-4 lg:mb-[-60px] mb-0 overflow-hidden' id="path_1">
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/Recruitment/screenshot_1.png" alt="" className='w-[560px] h-full' />
                    </div>
                </div>
            </section>
                            ...
                            <div className='content_containers_div'>
                                <div className='single_content'>
                                    <div className='inside_contents'>
                                        <div className='w-[40%]'>
                                            <img src="/Recruitment/content_01.png" alt="" />
                                        </div>
                                    ...
                                    <div className='inside_contents'>
                                        <div className='w-[40%]'>
                                            <img src="/Recruitment/content_02.png" alt="" />
                                        </div>
                                    ...
                                    <div className='inside_contents'>
                                        <div className='w-[40%]'>
                                            <img src="/Recruitment/content_03.png" alt="" />
                                        </div>
                                    ...
                                    <div className='inside_contents'>
                                        <div className='w-[40%]'>
                                            <img src="/Recruitment/content_04.png" alt="" />
                                        </div>
                                    ...
                                    <div className='inside_contents'>
                                        <div className='w-[40%]'>
                                            <img src="/Recruitment/content_05.png" alt="" />
                                        </div>
                                    ...
                                    <div className='inside_contents'>
                                        <div className='w-[40%]'>
                                            <img src="/Recruitment/content_06.png" alt="" />
                                        </div>
                ...
                <section className='lg:hidden block px-4 py-10 overflow-hidden' >
                    ...
                    <div className='w-[92%] ml-auto mb-[32px]'>
                        <div className='relative'>
                            ...
                            <img src="/Recruitment/res_content_01.png" alt="" className='w-[50%] h-full ml-auto' />
                        </div>
                    ...
                    <div className='w-[92%] mb-[32px]'>
                        <div className='relative'>
                            ...
                            <img src="/Recruitment/res_content_02.png" alt="" className='w-[50%] h-full ' />
                        </div>
                        <div className='p-4 shadow-shadow6x bg-light-white2'>
                    ...
                    <div className='w-[92%] ml-auto mb-[32px]'>
                        <div className='relative'>
                            ...
                            <img src="/Recruitment/res_content_03.png" alt="" className='w-[50%] h-full ml-auto' />
                        </div>
                        <div className='p-4 shadow-shadow6x bg-light-white2'>
                    ...
                    <div className='w-[92%] mb-[32px]'>
                        <div className='relative'>
                            ...
                            <img src="/Recruitment/res_content_04.png" alt="" className='w-[50%] h-full ' />
                        </div>
                        <div className='p-4 shadow-shadow6x bg-light-white2'>
                    ...
                    <div className='w-[92%] ml-auto mb-[32px]'>
                        <div className='relative'>
                            ...
                            <img src="/Recruitment/res_content_05.png" alt="" className='w-[50%] h-full ml-auto' />
                        </div>
                        <div className='p-4 shadow-shadow6x bg-light-white2'>
                    ...
                    <div className='w-[92%] mb-[32px]'>
                        <div className='relative'>
                            ...
                            <img src="/Recruitment/res_content_06.png" alt="" className='w-[50%] h-full ' />
                        </div>
                        <div className='p-4 shadow-shadow6x bg-light-white2'>
            ...
            <section className="bg-[#FAFAFA] shadow-shadow1x text-[#FAFAFA] lg:mt-10 mt-0 lg:mb-[-60px] mb-0 overflow-hidden">
                <div className="main_container flex justify-between items-center lg:py-[80px] py-[20px] px-4 relative">
                    ...
                    <div className="image_container2 lg:translate-x-[110px] translate-x-0">
                        <img src="/Recruitment/recruitment_business_team.png" alt="" className="w-ful h-full" />
                    </div>
                </div>
            </section>
                ...
                <div className='main_container'>
                    ...
                    <div className='flex lg:flex-row flex-col-reverse justify-between items-center gap-5'>
                        <div className='lg:w-[60%] w-full'>
                            <img src="/Recruitment/icons/star.png" alt="" className='mx-auto lg:block hidden' />
                            <div className='mx-auto rounded-lg lg:bg-light-white2 lg:p-10 p-5 lg:mt-0 mt-[-136px] relative z-10'>
                                <div className='lg:block flex items-center justify-center mb-4'>
                                    <img src="/Recruitment/icons/star.png" alt="" className='mx-auto lg:hidden block w-[42px] h-[42px]' />
                        ...
                        <div className='lg:w-[40%] w-full flex justify-center items-center white_linear_gradient'>
                            <div className='w-[300px] h-[300px] relative z-10'>
                                ...
                                <img src="/Recruitment/talent_person.png" alt="" className='w-full h-full relative z-10' />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className='main_container flex lg:flex-row flex-col justify-between items-center lg:gap-6 gap-0'>
                    ...
                    <div className='lg:w-[45%] w-full left_line'>
                        ...
                        <div className="lg:mt-[30px] mt-5 lg:text-left text-center">
                            <a className="action_btn2 lg:px-7 px-5 lg:py-[12px] py-2">Start Here</a>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className='scrollSection lg:-mt-20 mt-0 px-4 lg:pt-44 lg:pb-10 pt-6 pb-0' id="path_5">
                <div className='main_container'>
                    ...
                    <div className='lg:bg-light-white mt-[20px] relative'>
                        ...
                        <img src="/Recruitment/environment.png" alt="" className='mx-auto lg:translate-y-[-90px] translate-y-0 lg:w-[860px] lg:h-[260px] w-[300px] h-[175px] object-cover lg:object-none' />
                    </div>

                    <div className='lg:w-[50%] w-[95%] mx-auto rounded-lg bg-light-white2 lg:p-10 p-5 lg:mt-[-180px] mt-[-40px] relative z-10'>
                        <div className='flex items-center mb-4'>
                            <img src="/Recruitment/icons/microphone.png" alt="" />
            ...
            <section className="footer_bottom_cta_recruitment">
                <div className="main_container">
                    <div className="lg:w-[70%] w-full mx-auto text-center">
                        <img src="/Recruitment/footer_bottom_cta.png" alt="" className="block mx-auto mb-5 lg:w-[198px] w-[100px]" />
                        <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 font-semibold lg:mb-2 mb-2">Ready to <span className="text-green font-semibold">Boost</span> Your Hiring Efficiency?</h2>
                        <p className="lg:text-[18px] text-[12px] lg:font-semibold font-normal inter text-light-white2">Try Our AI-Powered Recruitment Module Today and Experience the Difference!</p>
...
const route_pages = [
    {
        link: "path_1",
        img: "/Recruitment/icons/document.png",
    ...
    {
        link: "path_2",
        img: "/Recruitment/icons/report.png",
    ...
    {
        link: "path_3",
        img: "/Recruitment/icons/user.png",
    ...
    {
        link: "path_4",
        img: "/Recruitment/icons/person_tic.png",
    ...
    {
        link: "path_5",
        img: "/Recruitment/icons/microphone.png",
