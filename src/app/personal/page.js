...
useEffect(() =>{
    ...
    const manual_resource = {
        ...
        img1 : "/personal/icons/files.png",
        img2 : "/personal/icons/work_speed.png",
        img3 : "/personal/icons/doc_err.png",
        manualImage : "/personal/personal.png",
    ...
    const details01 = {
        ScreenShot : '/personal/screenshot_1.png',
    ...
    const details02 = {
        ScreenShot : '/personal/screenshot_2.png',
    ...
    const details03 = {
        ScreenShot : '/personal/screenshot_3.png',
    ...
    const details04 = {
        ScreenShot : '/personal/screenshot_4.png',
    ...
    const details05 = {
        ScreenShot : '/personal/screenshot_5.png',
    ...
    const details06 = {
        ScreenShot : '/personal/screenshot_6.png',
    ...
    const details07 = {
        ScreenShot : '/personal/screenshot_7.png',
    ...
    const details08 = {
        ScreenShot : '/personal/screenshot_8.png',
        ...
        content02 : "Simplify credential management with WorkWise’s centralized platform, allowing employees to manage all their software access efficiently, allowing them to reduce security risks and time spent on managing access controls."
    }

    const details09 = {
        ScreenShot : '/personal/screenshot_9.png',
    ...
    return (
        <>
           ...
           <div className='lg:hidden block  sticky_personal bg-[#FFF] z-30'>
           ...
           {/* Personal banner section */}
            ...
            <nav className='lg:block hidden sticky lg:top-[75px] top-0 z-50 mb-24 mt-20'>
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-20 mb-0 lg:mt-[-80px] mt-0' id="path_1">
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_1.png" alt="" className='w-full h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-10 mb-8 lg:mt-[-80px] mt-0' id="path_2">
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-20px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_2.png" alt="" className='w-[580px] h-full lg:object-contain object-none' />
                    </div> 
            ...
            <section className='next_level px-4 relative lg:py-0 py-5 lg:mb-10 mb-0 lg:mt-14 mt-8'>
                <img src="/Finance/Budget_management/person-2.png" alt="" className='h-[100%] absolute top-0 right-[6px] lg:hidden block' />
                <div className='max-w-[1040px] mx-auto flex justify-between items-center'>
                    ...
                    <p className='inter font-extralight lg:text-[22px] text-[9px] text_gradient_personal lg:pr-[200px] pr-0'>Discover How Our Features Boost Workplace Productivity</p>
                        <div className="lg:mt-10 mt-2 text-left">
                          <a href="" className="lg:text-[16px] text-[8.8px] action_btn lg:px-7 px-3 lg:py-[10px] py-[6px] ">Explore Features</a>
                        </div>
                    </div>
                    <div className="w-[48%] lg:block hidden">
                    <img src="/personal/person-2.png" alt="" className='w-[420px] mx-auto' />
                    </div>
                </div>
            </section>
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-10 mb-0 lg:mt-[-80px] mt-0' id="path_3">
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_3.png" alt="" className='w-full h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-10 mb-8 lg:mt-[-80px] mt-0' id="path_4">
                <div className='main_container flex_container relative'>
                    <div className='absolute top-[50%] left-0 w-[40%] h-[120%] bg-[#EAEAEA] translate-x-[-100px] translate-y-[-50%] border_top_right_radius lg:block hidden'></div>
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-20px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_4.png" alt="" className='w-[580px] h-full lg:object-contain object-none' />
                    </div> 
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-20 mb-0 lg:mt-[-80px] mt-0' id="path_5">
                <div className='main_container flex_container relative'>
                    <div className='lg:w-[50%] w-full'>
                    ...
                    <div className='absolute top-[50%] right-0 w-[55%] h-[100%] bg-[#EAEAEA] translate-x-[100px] translate-y-[-50%] border_bottom_left_radius lg:block hidden'></div>
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_5.png" alt="" className='w-full h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className="bg-[#FAFAFA] shadow-shadow1x text-[#FAFAFA] lg:mt-20 lg:mb-10 mt-0 mb-5 overflow-hidden">
                <div className="main_container flex justify-between items-center lg:py-[110px] py-[20px] px-4 relative">
                    <div className="lg:w-[51%] w-[50%] lg:ml-auto ml-0 lg:pl-[30px] pl-0">
                       <h3 className="inter font-semibold lg:text-[37.5px] text-[15px] mb-1 text-left lg:leading-[48px] leading-[22px] lg:pr-0 pr-[70px]"><span className='text-green font-semibold'>Empower</span><span className='text_gradient_personal'> Your Workforce</span></h3> 
                        ...
                        <div className="lg:mt-5 mt-5 text-left">
                            <a href="" className="action_btn lg:text-[18px] text-[16px] lg:px-[28px] px-[14px]  py-2">Get Started Today</a>
                        </div>
                    </div>

                    <div className="image_container_unique lg:translate-x-0 translate-x-[-80%]">
                        <img src="/personal/personal_business_team.png" alt="" className="w-full h-full" />
                    </div>
                </div>
            </section>
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-10 mb-8 lg:mt-[-80px] mt-0' id="path_6">
                <div className='main_container flex_container relative'>
                    <div className='absolute top-[50%] left-0 w-[40%] h-[100%] bg-[#EAEAEA] translate-x-[-100px] translate-y-[-50%] border_top_right_radius lg:block hidden'></div>
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-20px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_6.png" alt="" className='w-[580px] h-full lg:object-contain object-none' />
                    </div> 
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-10 mb-0 lg:mt-[-80px] mt-0' id="path_7">
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_7.png" alt="" className='w-[540px] h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-10 mb-8 lg:mt-[-80px] mt-0' id="path_8">
                <div className='main_container flex_container relative'>
                    <div className='absolute top-[50%] left-0 w-[40%] h-[120%] bg-[#EAEAEA] translate-x-[-100px] translate-y-[-50%] border_top_right_radius lg:block hidden'></div>
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[-20px] left-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_8.png" alt="" className='w-[580px] h-full lg:object-contain object-none' />
                    </div> 
            ...
            <section className='scrollSection lg:pt-[200px] pt-[40px] lg:pb-[100px] pb-[40px] px-4 overflow-hidden lg:mb-10 mb-0 lg:mt-[-80px] mt-0' id="path_9">
                <div className='main_container flex_container relative'>
                    ...
                    <div className='absolute top-[50%] translate-y-[-50%] translate-x-[75px] right-0 w-[640px] h-[440px] lg:block hidden'>
                        <img src="/personal/screenshot_9.png" alt="" className='w-full h-full' />
                    </div>
                </div>
            </section>
            ...
            <section className="footer_bottom_cta_personal">
                <div className="main_container">
                    <div className="lg:w-[70%] w-full mx-auto text-center">
                    <img src="/personal/footer_bottom_cta.png" alt="" className="block mx-auto mb-5 lg:w-[198px] w-[100px]" />
                    <h2 className="inter lg:text-[37.5px] text-[20px] text-light-white2 font-semibold lg:mb-2 mb-2"><span className="text-green font-semibold">Boost</span> Employee Well-being</h2>
                    <p className="lg:text-[18px] text-[12px] lg:font-semibold font-normal inter text-light-white2">Enable Work-Life Balance and Stress-Free Operations</p>
